...
import { Briefcase, FileText, Flag, GraduationCap, Users, Download, EyeOff } from "lucide-react";
...
const CARDS = [
  ...
  { key: "pendingMentors", label: "Pending mentors", icon: GraduationCap, href: "/admin/mentors" },
  { key: "internships", label: "Internships", icon: Briefcase, href: "/admin/internships" },
...
export default async function AdminOverviewPage() {
  const [users, documents, pendingReports, downloadAgg, recentReports, suspendedUsers, hiddenDocs, hiddenComments, recentActions, pendingMentors, internships] =
    await Promise.all([
      prisma.user.count(),
